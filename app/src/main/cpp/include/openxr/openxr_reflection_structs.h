...
#define _impl_XR_LIST_ALL_STRUCTURE_TYPES_CORE(_avail, _unavail) \
    ...
    _avail(XrGoogleCloudAuthApiKeyANDROIDX2, XR_TYPE_GOOGLE_CLOUD_AUTH_API_KEY_ANDROIDX2) \
    _avail(XrGoogleCloudAuthTokenANDROIDX2, XR_TYPE_GOOGLE_CLOUD_AUTH_TOKEN_ANDROIDX2) \
    _avail(XrGoogleCloudAuthKeylessANDROIDX2, XR_TYPE_GOOGLE_CLOUD_AUTH_KEYLESS_ANDROIDX2) \
    _avail(XrGoogleCloudAuthErrorResultANDROIDX2, XR_TYPE_GOOGLE_CLOUD_AUTH_ERROR_RESULT_ANDROIDX2) \
